        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 py-12 md:py-16 lg:py-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-primary-foreground mb-4 leading-tight">
              Quality Fashion
              <span className="block text-gradient-gold">For Your Family</span>
            </h1>

            <p className="text-primary-foreground/80 text-lg md:text-xl mb-8 max-w-xl mx-auto lg:mx-0">
              Men's Wear • Ladies Wear • Kids Wear • Sarees • Jeans
            </p>
          ...
          <div className="flex-1 relative">
            <div className="relative w-full max-w-md mx-auto">
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-4 -left-4 bg-gold text-gold-dark px-6 py-3 rounded-xl shadow-elevated">
                <p className="font-display font-bold text-lg">Trusted Since 2010</p>
              </div>
            </div>
          </div>
        </div>
